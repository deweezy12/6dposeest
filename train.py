    ...
    for batch_idx, (data, target) in enumerate(test_loader):
        ...
        for box_pr, target in zip([all_boxes], [target[0]]):
            ...
            for k in range(num_gts):
                ...
                #Test to see them data
                print(f"corners3D = {corners3D}")
                print(f"corners2D_gt = {corners2D_gt}")
                print(f"internal_calibration = {internal_calibration}")
...
if __name__ == "__main__":
    ...
    region_loss = RegionLoss(num_keypoints=4, num_classes=1, anchors=[], num_anchors=1, pretrain_num_epochs=15)
