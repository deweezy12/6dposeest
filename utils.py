...
def get_region_boxes(output, num_classes, num_keypoints=4, only_objectness=1, validation=True):
...
def read_truths(lab_path, num_keypoints=4):
...
def read_truths_args(lab_path, num_keypoints=4):
